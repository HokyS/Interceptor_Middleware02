package com.example.Interceptor_Middleware02.interceptor;


import com.example.Interceptor_Middleware02.entities.Month;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (monthNumber != null) {
            ...
            if (monthFound.isPresent()) {
                request.setAttribute("month-middleware", monthFound.get());
            } else {
